 ...
 * @file           index.php
 * @package        Responsive 
 * @author         Takethecare.com 
 * @copyright      2013 - 2013 @ takethecare.com
 * @version        Release: 1.0
 */
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
  	...
  	<div class="blog-box">
        ...
        <span class="blog-date"><i class="icon-calendar"></i> Posted on <?php the_time('F j, Y'); ?> at <?php the_time('g:i a'); ?></span> <span class="blog-author"><i class="icon-user"></i> by: <?php the_author() /*the_author_posts_link()*/ ?></span> <span class="blog-comments pull-right"><i class="icon-comment"></i>  <a href="<?php comments_link(); ?>"><?php comments_number( 'no comments', 'one comment', '% comments' ); ?></a></span>
